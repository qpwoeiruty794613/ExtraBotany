...
public class GuiResonanceHouse extends GuiContainer{
	
	private TileResonanceHouse tile;
	
	public GuiResonanceHouse(InventoryPlayer playerInv, TileResonanceHouse tileEntity) {
         super(new ContainerResonanceHouse(playerInv, tileEntity));
    ...
    private GuiResonanceHouse.MerchantButton field_147043_x;
    private GuiResonanceHouse.MerchantButton field_147042_y;
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.field_147043_x = new GuiResonanceHouse.MerchantButton(1, i + 120 + 27, j + 24 - 1, true));
        this.buttonList.add(this.field_147042_y = new GuiResonanceHouse.MerchantButton(2, i + 36 - 19, j + 24 - 1, false));
    ...
    static class MerchantButton extends GuiButton
        {
            ...
            public void drawButton(Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_)
            {
                if (this.visible)
                {
                    p_146112_1_.getTextureManager().bindTexture(GuiResonanceHouse.field_147038_v);
                    GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
