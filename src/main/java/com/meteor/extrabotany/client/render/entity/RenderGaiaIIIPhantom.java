...
public class RenderGaiaIIIPhantom extends RenderBiped {
	...
	public static float DEFAULT_GRAIN_INTENSITY = 0.15F;
	public static float DEFAULT_DISFIGURATION = 0.055F;
	...
	public RenderGaiaIIIPhantom() {
		super(new ModelBiped(0.5F), 0F);
	}

	@Override
	public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
		EntityGaiaIIIPhantom dopple = (EntityGaiaIIIPhantom) par1Entity;
		...
		if(invulTime > 0) {
			...
			disfiguration = (0.055F + dopple.hurtTime * ((1F - 0.15F) / 20F)) / 2F;
			grainIntensity = 0.15F + dopple.hurtTime * ((1F - 0.15F) / 10F);
		}
